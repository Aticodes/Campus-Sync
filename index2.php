      ...
      if ($result) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          if ($row['type'] == 1) {
            ...
            //           window.location.href='login/verification.php';
            //           </script>";
            // }
            ...
            $u_id = $row['user_id'];
            $sqll = "SELECT professor_master.type  FROM `professor_master` JOIN user_master on user_master.user_id = professor_master.user_id WHERE user_master.user_id = $u_id ";
